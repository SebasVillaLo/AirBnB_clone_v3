...
if state_id_1 is None or state_id_1 == "":
    print("FAIL: Can't create State")
state_id_2 = exec_command(my_console, "create State name=\"Nevada\"")
if state_id_2 is None or state_id_2 == "":
    print("FAIL: Can't create State")
state_id_3 = exec_command(my_console, "create State name=\"Louisiana\"")
if state_id_3 is None or state_id_3 == "":
    print("FAIL: Can't create State")
